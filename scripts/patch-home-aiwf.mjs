...
(function () {
  ...
  function ensureHoverStyle() {
    ...
    st.textContent = '#molly-aiwf-section img[data-molly-cover]{transition:transform .55s cubic-bezier(.34,1.45,.64,1),opacity .3s ease !important;}' +
        ...
        '#molly-aiwf-section .molly-in:hover img[data-molly-cover]{transform:scale(.95) !important;opacity:.9 !important;}' +
        '#molly-aiwf-section .molly-in{transition:transform .3s cubic-bezier(.215,.61,.355,1),opacity .3s ease !important;}' +
        '#molly-aiwf-section .molly-in:hover{transform:scale(.95) !important;opacity:.8 !important;}' +
        '#molly-aiwf-section .molly-in:active{transform:scale(.95) !important;opacity:.8 !important;}' +
        '#molly-aiwf-section [data-molly-btn]{transition:transform .3s cubic-bezier(.215,.61,.355,1) !important;}' +
        '#molly-aiwf-section .molly-in [data-molly-btn]:hover{transform:scale(.9) !important;}';
